...
const VocabTestResult = () => {
    ...
    const handleReview = () => {
        navigate(`/courses/${course.id}/vocab`, {state: {parent_course_id: course.id}});
    };
    ...
    const handleRetake = () => {
        navigate(`/courses/${course.id}/vocab/test`, {state: {course_id: course.id}});
    }

    const handleViewAnswers = () => {
        navigate(`/courses/${course.id}/vocab/answers`, {state: {course_id: course.id, testAnswers: testAnswers}});
    }
