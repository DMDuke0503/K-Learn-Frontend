...
const RegisterForm = () => {
    ...
    return (
        <Form {...form} className="text-white">
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-wrap justify-center items-center space-x-5 py-3">
                <div className="w-[45%] space-y-5">
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input placeholder="Nhập họ" className="bg-white h-14 w-full rounded-3xl p-3 font-montserrat font-bold text-lg" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input placeholder="Nhập username" className="bg-white h-14 w-full rounded-3xl p-3 font-montserrat font-bold text-lg" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                        ...
                        <Popover>
                            ...
                            <FormControl className="bg-white h-14 w-full rounded-3xl p-3 font-montserrat font-bold text-lg">
                                <Button
                                variant={"outline"}
                ...
                <div className="w-[45%] space-y-5">
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input placeholder="Nhập tên" className="bg-white h-14 w-full rounded-3xl p-3 font-montserrat font-bold text-lg" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input type="email" placeholder="Nhập email" className="bg-white h-14 w-full rounded-3xl p-3 font-montserrat font-bold text-lg" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input type="password" placeholder="Nhập lại mật khẩu" className="bg-white h-14 w-full rounded-3xl p-3 font-montserrat font-bold text-lg" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                ...
                <Button className="w-[30%] h-[50px] my-5 rounded-2xl font-montserrat font-bold text-xl p-3" style={{border: "2px solid #959699"}} type="submit">ĐĂNG KÝ</Button>
            </form>
        </Form>
    );
}
